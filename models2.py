...
class MonyzeappProfile(models.Model):
    ...
    pass_reset_token = models.CharField(max_length=45, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'monyzeapp_profile'
